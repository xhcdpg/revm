...
## [2.0.0](https://github.com/xhcdpg/revm/compare/revm-primitives-v1.3.0...revm-primitives-v2.0.0) - 2024-02-02
...
- *(primitives)* don't duplicate the SpecId::enabled() logic ([#869](https://github.com/xhcdpg/revm/pull/869))
