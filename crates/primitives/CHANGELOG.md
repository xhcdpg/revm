...
## [6.0.0](https://github.com/xhcdpg/revm/compare/revm-primitives-v5.0.0...revm-primitives-v6.0.0) - 2024-06-29

### Added
- *(Prague)* Add EIP-7702 ([#1565](https://github.com/xhcdpg/revm/pull/1565))
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/xhcdpg/revm/pull/1567))
