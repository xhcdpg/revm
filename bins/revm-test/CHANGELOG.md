...
## [0.1.0](https://github.com/xhcdpg/revm/releases/tag/revm-test-v0.1.0) - 2024-07-18
...
### Fixed
- *(eof)* fixture 2 tests ([#1550](https://github.com/xhcdpg/revm/pull/1550))
- *(clippy)* fix some clippy lints

### Other
- bump versions bcs of primitives ([#1631](https://github.com/xhcdpg/revm/pull/1631))
- release ([#1620](https://github.com/xhcdpg/revm/pull/1620))
- *(deps)* bump alloy-sol-types from 0.7.6 to 0.7.7 ([#1614](https://github.com/xhcdpg/revm/pull/1614))
- *(deps)* bump alloy-sol-macro from 0.7.6 to 0.7.7 ([#1613](https://github.com/xhcdpg/revm/pull/1613))
- release ([#1579](https://github.com/xhcdpg/revm/pull/1579))
- release ([#1548](https://github.com/xhcdpg/revm/pull/1548))
- replace TransactTo with TxKind ([#1542](https://github.com/xhcdpg/revm/pull/1542))
- *(deps)* bump regex from 1.10.4 to 1.10.5 ([#1502](https://github.com/xhcdpg/revm/pull/1502))
